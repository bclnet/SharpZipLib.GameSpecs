...
{
	/// <summary>
	/// Cry3EntryFactory. Basic implementation of <see cref="IEntryFactory"></see>
	/// </summary>
	public class Cry3EntryFactory : IEntryFactory
	{
		#region Constructors

		/// <summary>
		/// Initialise a new instance of the <see cref="AesEntryFactory"/> class.
		/// </summary>
		/// <remarks>A default <see cref="INameTransform"/>, and the LastWriteTime for files is used.</remarks>
		public Cry3EntryFactory()
		{
		...
		/// <summary>
		/// Initialise a new instance of <see cref="AesEntryFactory"/> using the specified <see cref="TimeSetting"/>
		/// </summary>
		...
		public Cry3EntryFactory(TimeSetting timeSetting) : this()
		{
			timeSetting_ = timeSetting;
		}

		/// <summary>
		/// Initialise a new instance of <see cref="AesEntryFactory"/> using the specified <see cref="DateTime"/>
		/// </summary>
		/// <param name="time">The time to set all <see cref="ZipEntry.DateTime"/> values to.</param>
		public Cry3EntryFactory(DateTime time) : this()
		{
		...
		{
			var result = new Cry3Entry(nameTransform_.TransformFile(!string.IsNullOrEmpty(entryName) ? entryName : fileName));
		...
		{
			var result = new Cry3Entry(nameTransform_.TransformDirectory(directoryName));
			result.IsUnicodeText = isUnicodeText_;
			result.Size = 0;
