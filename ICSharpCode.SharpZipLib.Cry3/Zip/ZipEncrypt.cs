    ...
    public unsafe static class ZipEncrypt
    {
        ...
        public static void GetEncryptionInitialVector(ZipEntry fileEntry, out byte[] iv)
        {
            var intIV = new[] {
                ...
                (uint)unchecked(~fileEntry.CompressedSize),
                (uint)unchecked(fileEntry.Crc ^ (fileEntry.CompressedSize << 12)),
                (uint)unchecked(~fileEntry.Size ^ fileEntry.CompressedSize),
            };
            iv = new byte[16];
        ...
        // wolcen
        //30818902818100E2725EF9BB168871C238D91B64CFB8B1332F1BBCF105F40F25
        //2FB93F3A609D524CF8F5EE09BC554FD918DB8BB3531D6F88BEFEA4BFBDF51CB1
        //E1DF5E5DFA83FD6584D37E279924224FC4F8BB6C98ED50D27002E8BA21F35F01 
        //55A08D9ED276714032AEECDA066C17FA54F1C33E5DAF8B332B3CC0771490A152
        //61B2DD908F53F10203010001
