...
////const string PakPath = @"D:\Program Files (x86)\Steam\steamapps\common\Wolcen\Game\Sounds_WEM.pak";
...
//const string PakPath = @"D:\Program Files (x86)\Steam\steamapps\common\Warface\13_2000076\Game\Textures_Other.pak";
...
////const string PakPath = @"D:\Program Files (x86)\Steam\steamapps\common\SNOW\Assets\Sounds.pak";

// TEA (OK)
//const string AesKey = null;
//const string PakPath = @"D:\Program Files (x86)\Steam\steamapps\common\Ryse Son of Rome\GameRyse\GameData.pak";
//const string PakPath = @"D:\Program Files (x86)\Steam\steamapps\common\Ryse Son of Rome\GameRyse\Music.pak";
...
////const string PakPath = @"D:\Program Files (x86)\Steam\steamapps\common\Robinson The Journey\game_robinson\audio.pak";

// None (OK)
//const string AesKey = null;
//const string PakPath = @"D:\Program Files (x86)\Steam\steamapps\common\Crysis Remastered\Game\gamedata.pak";
////const string PakPath = @"D:\Program Files (x86)\Steam\steamapps\common\Crysis Remastered\Game\music.pak";
...
foreach (ZipEntry ent in pak)
{
    ...
    try
    {
        ...
        var newPath = Path.Combine(@"D:\T_\GameSpec\Warface\", ent.Name);
