...
namespace ICSharpCode.SharpZipLib.Zip
{
    ...
    public class P4kInputStream : ZipInputStream
    {
        ...
        //	if (method == (int)CompressionMethod_ZStd) throw new NotImplementedException("ZStd not implemented");
        //}
        ...
        {
            baseCloseEntry();
            if (method == (int)CompressionMethod_ZStd) throw new NotImplementedException("ZStd not supported");
        }
